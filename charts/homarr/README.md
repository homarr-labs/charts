...
![AppVersion: v1.1.0](https://img.shields.io/badge/AppVersion-v1.1.0-informational?style=flat)
...
| image.tag | string | `"v1.1.0"` | Overrides the image tag whose default is the chart appVersion |
