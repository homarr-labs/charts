...
![Version: 8.29.1](https://img.shields.io/badge/Version-8.29.1-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.77.1](https://img.shields.io/badge/AppVersion-v1.77.1-informational?style=flat)
...
| image.tag | string | `"v1.77.1"` | Overrides the image tag whose default is the chart appVersion |
