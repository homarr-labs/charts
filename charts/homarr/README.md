...
![Version: 8.4.4](https://img.shields.io/badge/Version-8.4.4-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.45.3](https://img.shields.io/badge/AppVersion-v1.45.3-informational?style=flat)
...
| image.tag | string | `"v1.45.3"` | Overrides the image tag whose default is the chart appVersion |
