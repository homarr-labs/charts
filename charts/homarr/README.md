...
![AppVersion: v1.52.0](https://img.shields.io/badge/AppVersion-v1.52.0-informational?style=flat)
...
| image.tag | string | `"v1.52.0"` | Overrides the image tag whose default is the chart appVersion |
