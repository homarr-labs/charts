...
![Version: 3.3.0](https://img.shields.io/badge/Version-3.3.0-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.12.0](https://img.shields.io/badge/AppVersion-v1.12.0-informational?style=flat)
...
|------------|------|---------|
| <https://charts.bitnami.com/bitnami> | mysql | 12.3.1 |
...
| image.tag | string | `"v1.12.0"` | Overrides the image tag whose default is the chart appVersion |
