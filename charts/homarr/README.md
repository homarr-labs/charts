...
![Version: 8.29.2](https://img.shields.io/badge/Version-8.29.2-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.77.2](https://img.shields.io/badge/AppVersion-v1.77.2-informational?style=flat)
...
| image.tag | string | `"v1.77.2"` | Overrides the image tag whose default is the chart appVersion |
