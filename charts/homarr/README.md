...
![Version: 8.16.1](https://img.shields.io/badge/Version-8.16.1-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.58.1](https://img.shields.io/badge/AppVersion-v1.58.1-informational?style=flat)
...
| image.tag | string | `"v1.58.1"` | Overrides the image tag whose default is the chart appVersion |
