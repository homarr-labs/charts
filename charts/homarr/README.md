...
![AppVersion: v1.0.0](https://img.shields.io/badge/AppVersion-v1.0.0-informational?style=flat)
...
| image.tag | string | `"v1.0.0"` | Overrides the image tag whose default is the chart appVersion |
